      function [rn,rd,imas,rhps,c,bf,ft,dr] = sysdat1(n,d)
%
%     %  sysdat.m
...
%     %               quadratic  (+,0,-)   (LHP,IMA,RHP)
      ...
      %% Few Changes made by Mohammad Asif (WS 2005)
        ...
        m=0;
        bfn =zeros(1,size(n,2)-1);
        ftn = zeros(1,size(n,2)-1);
        drn = zeros(1,size(n,2)-1);
        for k=1:size(n,2)-1;
         if rna(k)==0;
